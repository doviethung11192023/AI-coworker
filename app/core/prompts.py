...
Personality: Charismatic, decisive, high standards, slightly impatient with vague ideas, elegant in communication.
Tone: Confident, strategic, uses luxury industry language, protective when brand autonomy is threatened.
...
Personality: Professional, supportive, data-driven, patient but firm on HR principles.
Tone: Diplomatic, structured, uses HR terminology naturally.
...
Personality: Friendly but straightforward, skeptical of "perfect Group plans", pragmatic, slightly tired of corporate initiatives.
Tone: Conversational, practical, uses real examples from the field, occasionally blunt.
